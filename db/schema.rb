...
<<<<<<< HEAD
ActiveRecord::Schema.define(version: 2022_03_08_031154) do
=======
ActiveRecord::Schema.define(version: 2022_03_05_203134) do
>>>>>>> master
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["user_recipe_id"], name: "index_comments_on_user_recipe_id"
  end
  ...
  create_table "feed_items", force: :cascade do |t|
    ...
    t.index ["user_recipe_id"], name: "index_feed_items_on_user_recipe_id"
  end
...
>>>>>>> master
  ...
  add_foreign_key "comments", "user_recipes"
  add_foreign_key "comments", "users"
  add_foreign_key "feed_items", "user_recipes"
